    ...
    StoreSection(
      ...
      items: [
        mk(
          'cafe',
          'Кофейня',
          'Заказ, оплата и мелочи у стойки',
          'Повседневная жизнь',
          16,
          'A2',
          false,
    ...
    StoreSection(
      ...
      items: [
        mk(
          'interview',
          'Собеседование',
          'Рассказ о себе и переговоры об условиях',
          'Работа и карьера',
          22,
          'B1–B2',
          true,
        ...
        mk(
          'office',
          'Офис и созвоны',
          'Митинги, статусы и договорённости',
          'Работа и карьера',
          19,
          'B1',
          true,
...
class _PreviewFlags extends FeatureFlagsController {
  @override
  FeatureFlags build() =>
      const FeatureFlags(storeEnabled: true, paywallEnabled: true, devPremium: false);
}

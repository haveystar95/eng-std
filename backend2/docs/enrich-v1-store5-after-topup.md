...
Версия генератора: `enrich-v1-topup`.
...
- **дистракторы:**
    ...
    - `I prefer to use my debit card for everyday purchases.` — modal_to: **prefer to use** → `prefer using`
...
- **дистракторы:**
    ...
    - `Could you help me with this form? I'm not sure to fill it out.` — modal_to: **to fill** → `fill`
...
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «cash machine» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **дистракторы:**
    ...
    - `I set up the standing order to pay my rent each month.` — article: **the standing order** → `a standing order`
- **флаги:**
...
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «to open an account» — ни эталон, ни варианты этого не покрывают; переформулировать.
    - ✍️ **не слово → правка** — «подключить» — в данном контексте правильное «оформить».
...
- **дистракторы:**
    ...
    - `I pay my utility bills through direct debit.` — preposition: **through** → `by`
...
- **дистракторы:**
    ...
    - `I opened the savings account for future expenses.` — article: **the savings account** → `a savings account`
...
- **дистракторы:**
    ...
    - `Do you offer the online banking services?` — article: **the online banking services** → `online banking services`
    - `Do you offer online banking at services?` — preposition: **at** → `services`
...
- **дистракторы:**
    ...
    - `I scheduled a meeting with my financial advisors to discuss investments.` — word_order: **financial advisors** → `financial advisor`
...
- **принимаемые варианты:**
    ...
    - `monthly invoice` — _Синоним, который также может описывать аналогичный документ._
- **дистракторы:**
...
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «to inspect an apartment» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **дистракторы:**
    ...
    - `Please read the lease agreement carefully before signing it.` — word_order: **before signing it** → `before signing.`
...
- **дистракторы:**
    ...
    - `What is your preferred move-in date?` — word_order: **What is your** → `What's your`
- **флаги:**
...
- **дистракторы:**
    ...
    - `The tenant is responsible for the minor repairs.` — article: **the minor repairs** → `minor repairs`
...
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «to sign a lease» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «repair application» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **флаги:**
    - ✍️ **не слово → правка** — уведомления; уведомление
...
- **флаги:**
    - 🌐 **не тот язык** — Слово «жильё» написано правильно, но до русского текста добавлено английское слово «shared».
    - ⚠️ **переформулировать** — Обратный перевод даёт «co-living» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **принимаемые варианты:**
    ...
    - `pay for the rent` — _Такое же значение, передающее суть._
...
- **дистракторы:**
    ...
    - `I pay the rent bank transfer every month.` — word_order: **rent bank transfer** → `the rent by bank transfer`
    - `I pays the rent by bank transfer every month.` — tense: **pays** → `pay`
- **флаги:**
    - ✍️ **не слово → правка** — Нет ошибочно написанных слов или несуществующих форм.
...
- **дистракторы:**
    ...
    - `Do you have the permission to sublet the apartment?` — article: **the permission** → `permission`
...
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «I would like to register for a reception» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **дистракторы:**
    ...
    - `I have a headache since this morning.` — preposition: **since** → `for`
...
- **дистракторы:**
    - `How long have you been feeling this way before you come here?` — tense: **you come** → `you came`
...
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «I need to extend my prescription» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **дистракторы:**
    ...
    - `Did the doctor give you any medicines?` — word_order: **any medicines** → `medicines any`
...
- **дистракторы:**
    ...
    - `Running a temperature since last night is he.` — word_order: **is he** → `he is`
    - `He has been running a temperature since last night.` — tense: **has been** → `has been`
...
- **дистракторы:**
    ...
    - `Please take a seat, the doctor will see on you shortly.` — preposition: **on you** → `you shortly`
    - `Please take seat, the doctor will see you shortly.` — article: **seat** → `a seat`
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «Please sit down» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «get medicine by prescription» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **принимаемые варианты:**
    ...
    - `take your drugs` — _Можно использовать в контексте приема медикаментов._
- **дистракторы:**
...
- **дистракторы:**
    ...
    - `Could you tell me more about the team with which I would be working?` — word_order: **with which** → `which I would be working with`
...
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «What programming languages do you own?» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «What are the main duties of this position» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «environment that fosters collaboration» — ни эталон, ни варианты этого не покрывают; переформулировать.
    - 🌐 **не тот язык** — Слово "среда" в этом контексте не является правильным переводом для "environment". Правильный перевод — "окружающая среда".
...
- **дистракторы:**
    ...
    - `I have experience by agile methodologies.` — preposition: **by** → `with`
    - `I has experience with agile methodologies.` — tense: **I has** → `I have`
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «I have experience working with agile methodologies» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «What are your strong and weak points» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **дистракторы:**
    ...
    - `In the interview, I discussed the long-term goals in the IT industry.` — article: **the long-term goals** → `my long-term goals`
...
- **дистракторы:**
    ...
    - `I get along with the team well, making collaboration effective.` — article: **the team** → `my team`
...
- **флаги:**
    - 🌐 **не тот язык** — Работаю комфортно с; правильная форма - комфортно работаю с.
    - ⚠️ **переформулировать** — Обратный перевод даёт «I work comfortably with» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **флаги:**
    - ✍️ **не слово → правка** — слоник instead of столик
...
- **дистракторы:**
    ...
    - `I will have the chicken salads, please.` — word_order: **the chicken salads** → `the chicken salad`
    - `I will have chicken salad, please.` — article: **chicken salad** → `the chicken salad`
- **флаги:**
    - ✍️ **не слово → правка** — куриный салат (should be куриный салат)
...
- **дистракторы:**
    ...
    - `It's customary to leave a tips in restaurants here.` — article: **a tips** → `tips`
...
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «Can we have the bill, please?» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «to order food for delivery» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «Are you ready to place an order» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **флаги:**
    - 🌐 **не тот язык** — Фраза написана на английском языке.
...
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «dining utensils» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **дистракторы:**
    ...
    - `Can I have for some water, please?` — preposition: **for** → `some`
    - `Can I has some water, please?` — tense: **has** → `have`
- **флаги:**
    - ⚠️ **переформулировать** — Обратный перевод даёт «Can I have some water» — ни эталон, ни варианты этого не покрывают; переформулировать.
...
- **дистракторы:**
    ...
    - `The waiter will serve your meal в скором времени.` — false_friend: **в скором времени** → `shortly`
    - `The waiter will serve meal shortly.` — article: **meal** → `the meal`

...
- **A key, not a definition.** Ask it in these words: *could someone who does not know this term
  write `text` back from my translation alone?* If your line explains what the term MEANS — names a
  situation, adds «когда/из-за/который/то есть», or simply runs longer than the term it stands for —
  it is a description, and the card is unanswerable. Name the thing in the shortest {{source_lang}}
  expression a native would use.

...
- `example` — one short, natural {{target_lang}} sentence that uses `text`, and that ADDS something
  to it. Required for every item, with no exception — see the rule below.

...
final class LearningLadder
{
     ...
     * dealt as a first meeting is: the easy half of the matrix (choice and assembly), never typed
     * production or dictation, which ask the learner to reproduce a word they may be seeing for the
     * first time.
     *

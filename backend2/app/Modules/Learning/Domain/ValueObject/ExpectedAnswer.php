 ...
 * synonyms/translations), and whether the term is a phrase — phrases normalise punctuation and
 * spacing harder, and get a more forgiving default speed threshold.
 */
final readonly class ExpectedAnswer
{
    ...
    public function __construct(array $accepted, public bool $isPhrase = false)
    {

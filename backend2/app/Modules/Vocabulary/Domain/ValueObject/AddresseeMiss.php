 ...
 * category went missing, not which word of THIS source did. «Can you tell me about the growth
...
final readonly class AddresseeMiss
{
     ...
     * @param  list<string>  $words      the group's triggers this SOURCE actually uses, in its own order

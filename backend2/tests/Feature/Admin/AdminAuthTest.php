...
it('answers 401 (never a redirect/500) on every protected route without a token, even for a browser Accept', function () {
    ...
    $routes = [
        ...
        ['GET', "/admin/api/collections/{$id}/costs"],
        ['GET', "/admin/api/collections/{$id}/impact"],
        ['PATCH', "/admin/api/collections/{$id}"],
        ['POST', "/admin/api/collections/{$id}/terms"],
        ['DELETE', "/admin/api/collections/{$id}/terms/{$id}"],
        ['DELETE', "/admin/api/collections/{$id}"],
        ['GET', '/admin/api/costs'],
        ['GET', "/admin/api/terms/{$id}/impact"],
        ['PATCH', "/admin/api/terms/{$id}"],
        ['DELETE', "/admin/api/terms/{$id}"],
        ['GET', '/admin/api/terms'],

...
it('estimates a realtime session from billed seconds (audio tokens) plus transcript text', function () {
    // 2.1-mini: audio $10/$20 per 1M; 10 in / 20 out audio tokens per sec.
    // 120s → in 1200 tok = 0.012, out 2400 tok = 0.048; text 1000 in = 0.0006, 2000 out = 0.0048.
    // total = 0.065400.
    expect((new ModelCost())->estimateRealtime('gpt-realtime-2.1-mini', 120, 1000, 2000))->toBe('0.065400');
});

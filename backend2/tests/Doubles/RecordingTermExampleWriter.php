...
{
    /** @var list<array{termId: string, sentence: string, translation: string|null, translationLang: string, dropped: list<string>, source: string, promptVersion: string|null}> */
